...
# Kernel base version
KERNEL_BASE_VERSION = 4.14.246-0

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom androidboot.usbcontroller=a600000.dwc3 service_locator.enable=1 lpm_levels.sleep_disabled=1 loop.max_part=7 buildvariant=userdebug console=tty0
...
FLASH_INFO_DEVICE_IDS = surya karna
